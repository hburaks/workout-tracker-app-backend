...
public class CustomExerciseController extends BaseController<CustomExerciseRequestDTO, WorkoutExerciseResponseDTO, CustomExerciseEntity, CustomExerciseMapper, CustomExerciseRepository, CustomExerciseSpecification, CustomExerciseService> {
