...
public class WorkoutController extends BaseController<WorkoutRequestDTO, WorkoutResponseDTO, WorkoutEntity, WorkoutMapper, WorkoutRepository, WorkoutService> {
